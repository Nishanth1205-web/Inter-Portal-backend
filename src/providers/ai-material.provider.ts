...
// ============================================
// AI MATERIAL PROVIDER INTERFACES
// ============================================
...
export class MockAIMaterialGenerator implements IAIMaterialGenerator {
  async generate(input: AIMaterialGenerateInput): Promise<AIGeneratedMaterial> {
  ...
  private generatePPT(input: AIMaterialGenerateInput): AIGeneratedMaterial {
  ...
  private generateVideo(input: AIMaterialGenerateInput): AIGeneratedMaterial {
    const topic = input.topic || input.subject;
    return {
  ...
  private generateImage(input: AIMaterialGenerateInput): AIGeneratedMaterial {
    const topic = input.topic || input.subject;
    return {
  ...
  private generateDocument(input: AIMaterialGenerateInput): AIGeneratedMaterial {
    const topic = input.topic || input.subject;
    return {
...
export function createAIMaterialGenerator(provider: string): IAIMaterialGenerator {
  switch (provider) {
    case 'mock':
